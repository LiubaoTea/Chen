...
export class UserAddressEditor {
    ...
    async handleSubmit(e) {
        ...
        const formData = {
            ...
            is_default: this.container.querySelector('#isDefault').checked ? 1 : 0
        };
    ...
    fillFormWithAddress(address) {
        ...
        this.container.querySelector('#isDefault').checked = address.is_default === 1;
        ...
        if (regions.length === 3) {
            ...
            for (let i = 0; i < provinceSelect.options.length; i++) {
                if (provinceSelect.options[i].text === regions[0]) {
            ...
            setTimeout(() => {
                ...
                for (let i = 0; i < citySelect.options.length; i++) {
                    if (citySelect.options[i].text === regions[1]) {
                ...
                setTimeout(() => {
                    ...
                    for (let i = 0; i < districtSelect.options.length; i++) {
                        if (districtSelect.options[i].text === regions[2]) {
